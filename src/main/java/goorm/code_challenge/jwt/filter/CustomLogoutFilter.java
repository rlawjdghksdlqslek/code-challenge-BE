...
public class CustomLogoutFilter extends GenericFilterBean {
	...
	private void doFilter(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws IOException, ServletException {
		...
		if (refresh == null) {
			...
			sendErrorResponse(response,ErrorCode.BAD_REQUEST,"유효하지 않은 토큰입니다");
			return;
		}
		...
		try {
			...
			sendErrorResponse(response,ErrorCode.BAD_REQUEST,"이미 만료된 토큰입니다");
			return;
		}
		...
		sendErrorResponse(response,ErrorCode.OK,"로그아웃 되었습니다");
	}
